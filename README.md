# Travel Plan Web v2.43.11

## v2.43.11 说明

- 去掉移动端刷新同步后的 Data loaded 弹出提示。
- 将加载 / 同步状态和更新时间显示到版本号后面，例如 `Data loaded 09:54` 或 `Synced 09:54`。
- 版本号后面只显示时间，不再显示完整 `Updated: 5/8/2026...` 日期。
- 保留 v2.43.8 的 More 悬浮按钮、当前计划选择和查询折叠逻辑。
